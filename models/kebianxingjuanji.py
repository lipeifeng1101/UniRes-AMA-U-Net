...
class GT_U_Net(nn.Module):
    def __init__(self, img_ch=3, output_ch=1,):
        ...
        self.inc = inconv(img_ch, 64)#1，16
        self.down1 = deform_down(64 , 128 )
        self.down2 = deform_down(128 , 256 )
        self.down3 = down(256 , 512)
        self.down4 = down(512 , 512)
        self.up1 = up(1024, 256)
        self.up2 = up(512 , 128 )
        self.up3 = deform_up(256 , 64 )
        self.up4 = deform_up(128 , 64 )
        self.outc = nn.Conv2d(65 , 2, 1)

    def forward(self, inp):
        # encoding path
        #x1 = self.Conv1(x)              ## 1*3*512*512 ->conv(3,64)->conv(64,64)-> 1*64*512*512
        x1 = self.inc(inp)                # 1*64*512*512 -> 1*64*512*512
